...
export function Button({
    ...
    return (
        <button
            ...
            className={`inline-flex min-h-12 items-center justify-center gap-2 rounded-lg px-5 text-[1.0625rem] font-semibold transition-all duration-150 active:scale-[0.98] active:opacity-80 disabled:pointer-events-none disabled:opacity-40 ${VARIANTS[variant]} ${className}`}
        >
            {loading ? (
