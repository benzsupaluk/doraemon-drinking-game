...
/**
 * What the site gives you over a real deck, in the order a new player cares.
 *
 * Rendered in the guide and handed to schema.org's `featureList`, so the markup
 * only ever claims features the page actually shows.
 */
export const SITE_FEATURES = [
    'เล่นฟรีทั้งหมด ไม่มีค่าสมัครและไม่มีโฆษณาคั่นกลางเกม',
    'ไม่ต้องโหลดแอป ไม่ต้องสมัครสมาชิก เปิดผ่านเบราว์เซอร์บนมือถือได้เลย',
    'ไม่ต้องมีไพ่จริง ระบบสับไพ่ทั้ง 52 ใบให้เอง',
    'เล่นพร้อมกันได้ 2–12 คน แชร์ลิงก์เดียวให้ทั้งวง',
    'ระบบจดกติกาและคำสั่งไพ่ราชาไว้ให้ ไม่ต้องเถียงกันว่าใครจับบัดดี้กับใคร',
    'ถึงตาใครมือถือจะสั่นและมีเสียงกระดิ่งเตือน ไม่มีใครหลุดวง',
] as const
...
export const FAQ = [
    ...
    {
        question: 'เล่นฟรีไหม มีค่าใช้จ่ายอะไรบ้าง',
        answer:
            'เล่นฟรีทั้งหมด ไม่มีค่าสมัคร ไม่มีการซื้อของในเกม และไม่ต้องผูกบัตรอะไรเลย ' +
            'เปิดเว็บแล้วสร้างวงได้ทันที',
    },
    {
